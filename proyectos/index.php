...
include '../includes/header.php';
    ...
    <a href="../proyectos/crear.php" class="btn btn-success mb-3">Nuevo Proyecto</a>
    <table class="table table-bordered table-hover">
        ...
        <?php while($row=$result->fetch_assoc()){ ?>
            <tr>
                ...
                <td>
                    <a href="../proyectos/editar.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Editar</a>
                    <a href="../proyectos/eliminar.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Eliminar?');">Eliminar</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
